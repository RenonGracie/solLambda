...
from utils.request_utils import get_booking_settings, search_appointments, get_appointment, create_appointment, update_appointment, \
    appointment_cancellation

__tag = Tag(name="Appointments")
appointment_api = APIBlueprint("appointments", __name__, abp_tags=[__tag], abp_security=[{"jwt": []}], url_prefix="/appointments")


@appointment_api.get("/settings", responses={200: BookingSettings}, summary="Get booking settings")
def get_settings():
...
@appointment_api.get("/<int:appointment_id>", responses={200: Appointment}, summary="Get an existing appointment")
